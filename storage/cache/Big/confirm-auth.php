...
<div class="container-auth">
	<div class="content-auth">
		...
		<form action="<?php echo route('FastDB.configm-auth-handler'); ?>?redirect=<?php echo Common::getPrevUrl(); ?>" method="post" class="grid" style="min-width: 400px;max-width:100%;width:auto">
