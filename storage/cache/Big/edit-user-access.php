                ...
                <input type="hidden" name="cdm_token"value="<?php echo protection_token(); ?>">
                    ...
                    <div style="position: relative;left: 20px;">
                        ...
                        <div style="position: relative;left: 20px;margin-top: 6px">
                            ...
                            <label for=""><input type="checkbox" empty-checkbox="true" name="privilege[edit-tabel-data]" select-checkbox="all-privileges" class="marker" <?php echo $access['edit-tabel-data'] === true ? 'checked' : ''; ?>> <span class="span-privilege">Редактирование Записей</span></label>
