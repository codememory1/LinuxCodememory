<?php echo \View::theme('menu-doc'); ?>
<?php $link = Request::get('link');?>

<?php if($link === 'commands_introduction'): ?>
...
<?php elseif($link === 'commands_instruction'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_cmd-show'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_cmd-embed'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_cmd-update'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_cmd-delete'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_flags-for-Teams_flag-where'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_flags-for-Teams_flag-limit'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_flags-for-Teams_flag-sort-by-numbers'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_flags-for-Teams_flag-if'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
        <h3>1.3.5 Флаг IF</h3>
        <div class="doc-similar-request"></div>
...
<?php elseif($link === 'commands_available-Commands_flags-for-Teams_flag-notIf'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
...
<?php elseif($link === 'commands_available-Commands_flags-for-Teams_flag-instruction'): ?>
<div class="perk-content-link">
    <div class="doc-title-page">
