...
<div class="container-menu">
    <div class="content-menu">
        <ul class="ul-menu">
            ...
            <li class="item-menu"><a href=""><i class="fas fa-terminal"></i> <span>Консоль</span></a></li>
            ...
            <li class="item-menu"><a href=""><i class="fas fa-trash-restore"></i> <span>Хранилище удаленных данных</span></a></li>
            <li class="item-menu"><a href=""><i class="fas fa-presentation"></i> <span>Представления</span></a></li>
            ...
            <li class="item-menu"><a href=""><i class="fas fa-cogs"></i> <span>Настройки</span></a></li>
        </ul>
    </div>
</div>